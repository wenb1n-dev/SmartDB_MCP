...
def get_db_configs() -> Dict[str, Dict[str, Any]]:
    ...
    # 优先从配置文件读取
    config_file = os.getenv("DATABASE_CONFIG_FILE", "database_config.json")
...
def save_db_configs(configs: Dict[str, Dict[str, Any]], file_path: str = "database_config.json"):
    """保存数据库配置到文件
...
def create_sample_config(file_path: str = "database_config.json"):
    """创建示例配置文件
    ...
    save_db_configs(sample_config, file_path)
